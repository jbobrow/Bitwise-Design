<div class="grid_6 omega">
  <div id="sale">
	Available on <a href="http://www.shapeways.com/model/956722/magsafe-adapter-key-ring.html?li=productBox-search">Shapeways.com</a>
  </div>
  <div id="sidebar">

	<?php 
    if ( ! dynamic_sidebar( 'retina-primary-sidebar' ) ):
    ...
    <div class="widget widget_pages widget-widget_pages">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Pages', 'retina' ); ?></h3>
    ...
    <div class="widget widget_categories widget-widget_categories">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Categories', 'retina' ); ?></h3>
    ...
    <div class="widget widget_archive widget-widget_archive">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Archives', 'retina' ); ?></h3>
    ...
    <div class="widget widget_calendar widget-widget_calendar">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Calendar', 'retina' ); ?></h3>
        <?php get_calendar(); ?>
      </div>
    </div>
    ...
    <div class="widget widget_recent_entries widget-widget_recent_entries">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Recent Posts', 'retina' ); ?></h3>
    ...
    <div class="widget widget_tag_cloud widget-widget_tag_cloud">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Tag Cloud', 'retina' ); ?></h3>
    ...
    <div class="widget widget_text widget-widget_text">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'About Retina', 'retina' ); ?></h3>
        <div class="textwidget"><?php printf( __( '%s', 'retina' ), $retina_theme_data['Description'] ); ?></div>
      </div>
    </div>
    
    <div class="widget widget_meta widget-widget_meta">
      <div class="widget-wrap widget-inside">
        <h3 class="widget-title"><?php _e( 'Meta', 'retina' ); ?></h3>
          <ul>
            <?php wp_register(); ?>
